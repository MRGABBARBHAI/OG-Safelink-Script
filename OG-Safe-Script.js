...
(function() {
  ...
  // POST PAGE
    ...
    if (timerBox && btnBox) {
      ...
      const popup = createEl('div', '', `<div id="sl-overlay-popup"><div class="sl-popup-content"><h3 style="margin-top:0; color:#333;">Verification Required</h3><div class="ad-placeholder">REPLACE THIS TEXT WITH YOUR TOP AD CODE</div><div class="timer-pill-box" style="margin:10px auto; min-width:auto; padding:10px 20px; font-size:14px;">Wait <span id="p-time">${safeConfig.popupWait}</span> Seconds</div><div class="ad-placeholder">REPLACE THIS TEXT WITH YOUR BOTTOM AD CODE</div><p style="font-size:11px; color:#999; margin-top:5px;">Please wait for the timer to finish.</p></div></div>`);
